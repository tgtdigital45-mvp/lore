    ...
    >
      ...
      >
        <View style={{ width: inner, height: inner * 0.9, alignItems: "center", justifyContent: "center" }}>
          <Glyph shapeId={shapeId} size={inner * 0.85} />
        </View>
      </View>
    </View>
  );
...
function Glyph({ shapeId, size }: { shapeId: MedicationShapeId; size: number }) {
  const w = size;
  const h = size * 0.85;
  const white = "#FFFFFF";
  ...
  switch (shapeId) {
    ...
    case "liquid_bottle":
      return (
        <View style={{ alignItems: "center" }}>
          <View style={{ width: w * 0.35, height: h * 0.12, borderRadius: 2, backgroundColor: white }} />
          <View
            style={{
              width: w * 0.55,
              height: h * 0.55,
    ...
    case "pill_bottle":
      return (
        <View style={{ alignItems: "center" }}>
          <View style={{ width: w * 0.45, height: h * 0.1, backgroundColor: white, borderRadius: 2 }} />
          <View
            style={{
              width: w * 0.62,
              height: h * 0.52,
    ...
    case "measuring_cup":
      return (
        <View style={{ alignItems: "center" }}>
          ...
          />
          <View style={{ width: w * 0.55, height: 3, backgroundColor: white, marginTop: -2 }} />
        </View>
      );
    case "tube":
      return (
    ...
    case "diamond":
      return (
        <View style={{ transform: [{ rotate: "45deg" }] }}>
          <View style={{ width: w * 0.45, height: w * 0.45, backgroundColor: white, borderRadius: 2, opacity: 0.95 }} />
        </View>
      );
    case "diamond_wide":
      return (
        <View style={{ transform: [{ rotate: "45deg" }] }}>
          <View style={{ width: w * 0.62, height: w * 0.38, backgroundColor: white, borderRadius: 2, opacity: 0.95 }} />
        </View>
      );
    case "triangle":
      return (
