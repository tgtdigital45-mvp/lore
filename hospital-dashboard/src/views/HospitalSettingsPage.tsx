...
export function HospitalSettingsPage() {
  ...
  return (
    ...
    >
      ...
      {loading ? (
        <div className="space-y-6" aria-busy aria-label="Carregando configurações">
      ...
      >
        ...
        {isAdmin ? (
          ...
          <p className="text-sm text-amber-800">Apenas usuárioes com perfil hospital_admin podem alterar estas definições.</p>
        )}
      </motion.form>
      ...
      <motion.div variants={listItemVariants}>
      <Card className="rounded-3xl border border-slate-200/80 p-6 shadow-sm">
        <h2 className="mb-4 text-lg font-bold">Equipe (lotações)</h2>
