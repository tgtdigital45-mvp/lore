/** Alinha nomes vindos da IA (EN/abrev.) aos rótulos usados nos gráficos (pt-BR). */
const RULES: { re: RegExp; canonical: string }[] = [
...
/** Mesma lógica que o backend — valores de laboratório em pt-BR/en. */
export function parseLabNumericString(value: string): number | null {
